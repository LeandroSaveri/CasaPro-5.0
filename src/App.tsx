...
Quero que você faça APENAS as seguintes modificações neste arquivo, sem alterar absolutamente mais nada no código:
1.  Dentro da interface ProjectState, adicione a seguinte assinatura de método logo após saveProject:
clearCurrentProject: () => void;
2.  Dentro do objeto passado para persist((set, get) => ({ ... })), adicione a implementação do método logo após saveProject com o seguinte código:
clearCurrentProject: () => {
set({
currentProject: null,
history: [],
