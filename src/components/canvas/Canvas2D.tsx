...
import { Ruler, Magnet, Maximize2, Move, MousePointer2 } from 'lucide-react';
...
const Canvas2D: React.FC = () => {
  ...
  const getCanvasPoint = useCallback((e: React.PointerEvent | React.MouseEvent): Point | null => {
  ...
  }, [getCanvasPoint, canvasToWorld, isDrawing, drawStart, snapToAngle, getBestSnapPoint, updateDrawing, toolMode, isPanning, isDrawing, hitTest, offset, setCanvasOffset, panStart]);
